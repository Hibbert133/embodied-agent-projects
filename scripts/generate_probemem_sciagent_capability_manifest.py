"""Generate the immutable SciAgent Capability Contract v1.3 manifest."""
...
DEFAULT_CONFIG = ROOT / "configs/probemem_sciagent/api_reliability_v1_3.json"
...
def build_units(config: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    if (start, stop) != (6150, 6199) or len(units) != 50:
        raise ValueError("Capability Contract v1.3 requires seeds 6150--6199")
...
def main() -> int:
    ...
    try:
        ...
        run_id = f"probemem_sciagent_capability_{stamp}_{commit[:12]}"
        implementation = [
            ...
            ROOT / "scripts/generate_probemem_sciagent_capability_manifest.py",
        ...
        inputs = [
            ...
            ROOT / "docs/protocols/probemem_sciagent_capability_contract_v1_3.md",
        ]
        manifest = {
            "schema_version": 1,
